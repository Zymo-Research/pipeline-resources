...
2. Sequence Quality Histograms: quality scores of the reads at different positions. You want most of the reads to have above Q30, but if there are low quality at the ends in the pre-trimming plot, don't worry, they will get trimmed.
